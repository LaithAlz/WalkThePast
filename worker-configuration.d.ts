/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 998afa19108c9146a81a4be120468b3a)
// Runtime types generated with workerd@1.20260918.1 2025-09-01 nodejs_compat
interface __BaseEnv_Env {
	WORLDS: R2Bucket;
	ASSETS: Fetcher;
	OPENAI_REALTIME_MODEL: "gpt-realtime-2.1";
	ALLOWED_ORIGINS: "https://walk-the-past.vercel.app,*.vercel.app,http://localhost:5173,http://localhost:4173";
	CLERK_ISSUER: "https://engaging-horse-1989.clerk.accounts.dev";
	VITE_CLERK_PUBLISHABLE_KEY: string;
	OPENAI_API_KEY: string;
	JOB_STORE: DurableObjectNamespace<import("./worker/index").JobStore>;
	MARBLE_PIPELINE: Workflow<Parameters<import("./worker/index").MarbleWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_REALTIME_MODEL" | "ALLOWED_ORIGINS" | "CLERK_ISSUER" | "VITE_CLERK_PUBLISHABLE_KEY" | "OPENAI_API_KEY">> {}
}
