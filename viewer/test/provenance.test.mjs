// Unit test for the classifier: synthetic scene, no GPU. Run: node test/provenance.test.mjs
import assert from "node:assert/strict";
import * as THREE from "three";
import { computeProvenance, classifyPoint, makeSourceCamera, CLASS_VISIBLE, CLASS_OCCLUDED, CLASS_UNSUPPORTED } from "../dist-test/provenance.js";
