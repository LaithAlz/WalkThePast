...
export default function App() {
  ...
  return <Landing onUpload={() => (isSignedIn ? setScreen("upload") : openAuth("signup"))} onLogin={() => openAuth("login")} onSignUp={() => openAuth("signup")} onExplore={() => setScreen("samples")} />;
}
