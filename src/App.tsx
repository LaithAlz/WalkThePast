...
export default function App() {
  ...
  if (screen === "upload") return <Upload onBack={() => setScreen("landing")} onGenerate={startGeneration} onExplore={explore}  />;
  ...
  return <Landing signedIn={!!isSignedIn} onUpload={() => setScreen("upload")} onExplore={() => setScreen("samples")} />;
}
...
function Header({ onUpload, onLibrary, signedOut = false }: { onUpload?: () => void; onLibrary?: () => void; signedOut?: boolean }) {
...
function Upload({ onBack, onGenerate, onExplore }: { onBack: () => void; onGenerate: (gen: Generation) => void; onExplore: () => void }) {
